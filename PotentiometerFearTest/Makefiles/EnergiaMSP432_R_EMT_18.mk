...
#
#
# Last update: 15 Apr 2020 release 11.7.9
#
...
ifeq ($(MSP432_COLOUR),RED_ONLY)
    ENERGIA_MSP432_R_EMT_1    = $(ENERGIA_PACKAGES_PATH)/hardware/msp432r/$(ENERGIA_MSP432_R_EMT_RELEASE)
else
    ENERGIA_MSP432_R_EMT_1    = 0
endif

ifneq ($(wildcard $(ENERGIA_MSP432_R_EMT_1)),)
    ENERGIA_MSP432_R_EMT_APP    = $(ENERGIA_MSP432_R_EMT_1)
    ENERGIA_MSP432_R_EMT_PATH   = $(ENERGIA_MSP432_R_EMT_APP)
    ENERGIA_18_MSP432_R_EMT_BOARDS = $(ENERGIA_MSP432_R_EMT_1)/boards.txt
endif

ifneq ($(call PARSE_FILE,$(BOARD_TAG_18),name,$(ENERGIA_18_MSP432_R_EMT_BOARDS)),)
...
# ----------------------------------
#
REQUIRED_ENERGIA_MSP432_R_EMT_RELEASE = 5.25.0
ifeq ($(shell if [[ '$(ENERGIA_MSP432_R_EMT_RELEASE)' > '$(REQUIRED_ENERGIA_MSP432_R_EMT_RELEASE)' ]] || [[ '$(ENERGIA_MSP432_R_EMT_RELEASE)' = '$(REQUIRED_ENERGIA_MSP432_R_EMT_RELEASE)' ]]; then echo 1 ; else echo 0 ; fi ),0)
$(error Energia MSP432 Red release $(REQUIRED_ENERGIA_MSP432_R_EMT_RELEASE) or later required, release $(ENERGIA_MSP432_R_EMT_RELEASE) installed)
endif
...
PLATFORM_VERSION := MSP432 EMT $(ENERGIA_MSP432_R_EMT_RELEASE) for Energia $(ENERGIA_RELEASE)
BOARD_TAG        := $(BOARD_TAG_18)

HARDWARE_PATH     = $(ENERGIA_MSP432_R_EMT_PATH)
TOOL_CHAIN_PATH   = $(ENERGIA_PACKAGES_PATH)/tools/arm-none-eabi-gcc/$(ENERGIA_MSP432_R_GCC_ARM_RELEASE)/bin
