...
#
#
# Last update: 12 Nov 2019 release 11.3.5
#
...
PLATFORM_TAG      = ARDUINO=$(ARDUINO_RELEASE) ENERGIA=$(ENERGIA_RELEASE) ENERGIA_$(call PARSE_BOARD,$(BOARD_TAG),build.board) ENERGIA_ARCH_CC3200 EMBEDXCODE=$(RELEASE_NOW) DeviceFamily_CC3200
...
LDFLAGS     += -Wl,--entry=ResetISR -Wl,--unresolved-symbols=report-all
