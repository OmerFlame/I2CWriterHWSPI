...
#
#
# Last update: 20 Dec 2019 release 11.4.8
#
...
ARDUINO_180_PACKAGES_PATH = $(ARDUINO_180_LIBRARY_PATH)/packages
...
ifneq ($(MAKECMDGOALS),boards)
    ifneq ($(MAKECMDGOALS),clean)
        ...
        ifneq ($(ARDUINO_180_APP),)
            ...
            -include $(MAKEFILE_PATH)/nRF51_Boards_180.mk
            -include $(MAKEFILE_PATH)/chipKIT_180.mk
            -include $(MAKEFILE_PATH)/ESP8266_180.mk
            -include $(MAKEFILE_PATH)/ftDuino_180.mk
            -include $(MAKEFILE_PATH)/SeeeduinoAVR_180.mk
            -include $(MAKEFILE_PATH)/SeeeduinoSAMD_180.mk
        endif
...
#            -include $(MAKEFILE_PATH)/EnergiaMSP432EMT_18.mk
            -include $(MAKEFILE_PATH)/EnergiaMSP432_R_EMT_18.mk
