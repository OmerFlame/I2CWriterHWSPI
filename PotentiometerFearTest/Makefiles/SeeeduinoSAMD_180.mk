...
#
#
# Last update: 23 Apr 2020 release 11.7.14
#
...
# ----------------------------------
#
REQUIRED_SEEEDUINO_SAMD_RELEASE = 1.7.2
...
CMSIS_PATH        = $(SEEEDUINO_SAMD_PATH)/tools/CMSIS/$(ARDUINO_CMSIS_RELEASE)
CMSIS_ATMEL_PATH  = $(SEEEDUINO_SAMD_PATH)/tools/CMSIS-Atmel/$(ARDUINO_CMSIS_ATMEL_RELEASE)/CMSIS
...
MORE_FLAGS  += $(call SEARCH_FOR,$(BOARD_TAGS_LIST),build.cache_flags)
MORE_FLAGS  += $(call SEARCH_FOR,$(BOARD_TAGS_LIST),build.flags.maxqspi)
...
# Some boards specify some flags, other not. 
#
samd1010a    = $(call PARSE_BOARD,$(BOARD_TAG),compiler.arm.cmsis.ldflags)
L_FLAGS      = $(filter-out "-L{build.variant.path}", $(samd1010a))
ifeq ($(L_FLAGS),)
	L_FLAGS  = -larm_cortexM0l_math
endif
L_FLAGS    += -lc_s -lm
